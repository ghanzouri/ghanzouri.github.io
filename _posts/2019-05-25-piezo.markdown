...
{: refdef}
<center> Fig. 8: FMECA table </center>
...
{: refdef}
<center> Fig. 2: DSC analysis in amorphous state </center>
...
{: refdef}
<center> Fig. 12: Materials definition on Abaqus. </center>

{:refdef: style="text-align: center;"}
![Yosh Ginsu]({{site.baseurl}}/assets/img/piezo/fig28.jpg)
{: refdef}
<center> Fig. 12: Python script that imports CATIA sketch to speed up ABAQUS modelisation. </center>
